...
from keras.layers import Input, Embedding, Dense, Flatten, Concatenate, Activation, Dot, Add
...
plt.title('Residual Learning Mean Squared Error')
plt.xlabel('Epochs')
plt.ylabel('MSE')
plt.legend()
plt.savefig('Residual_MSE.png')
plt.show()
